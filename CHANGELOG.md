...
### Changed
- Refined build scripts to use Node-based file removal and conditional permission updates, ensuring consistent builds across platforms.
- Refreshed Open Graph preview image for sharper social sharing cards.
